    ...
    <div className="mt-6 grid gap-6 lg:grid-cols-3">
      ...
      <GlassCard title="What changes" subtitle="Inside an app workspace">
        <div className="grid gap-3 text-sm text-slate-700 dark:text-white/75">
          <div className="rounded-2xl bg-slate-900/5 px-4 py-3 ring-1 ring-slate-900/10 dark:bg-white/5 dark:ring-white/10">
        ...
        <div className="grid gap-3 text-sm">
          {suggestedApps.map((app) => (
            <Link
              ...
              className="flex items-center justify-between rounded-2xl bg-slate-900/5 px-4 py-3 font-semibold text-slate-700 ring-1 ring-slate-900/10 transition-colors hover:bg-slate-900/10 dark:bg-white/5 dark:text-white/80 dark:ring-white/10 dark:hover:bg-white/10"
            >
              <span>{app.label}</span>
